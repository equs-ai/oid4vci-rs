use super::Format;
use crate::metadata::credential_issuer::{CredentialMetadata, CredentialMetadataDisplay};
...
pub struct CredentialConfiguration {
    ...
    credential_metadata: Option<CredentialMetadata<CredentialMetadataDisplay>>,
}
...
impl CredentialConfiguration {
    ...
    field_getters_setters![
        pub self [self] ["VC SD-JWT metadata value"] {
            ...
            set_vct -> vct[String],
            set_credential_metadata -> credential_metadata[Option<CredentialMetadata<CredentialMetadataDisplay>>],
        }
    ];
}
